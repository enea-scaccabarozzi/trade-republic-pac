...
1. **FINDINGS.md maintenance**: Is FINDINGS.md being updated alongside code changes?
...
1. **Cross-experiment imports**: Experiments must not import Python code from other experiments. They can reference results by path.
