...
Usage: python docs/research/generate_figures.py
Output: docs/research/figures/*.png + printed claim validation
"""
...
# the script directly (python docs/research/generate_figures.py).
# ---------------------------------------------------------------------------
